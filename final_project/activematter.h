...
void find_mean_angle_of_neighbors(double x_current, double y_current, double *mean_theta, double *theta, double *x, double *y, int N, int R, double *sx_values, double *sy_values, int b);
